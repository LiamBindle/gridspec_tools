...
int main (int argc, char *argv[])
{
  ...
  */
   ...
   */
  {
    ...
    for(n=0; n<ntile_ocn; n++) {
      ...
      sprintf(topog_file, "%s/%s", dir, filename);
  ...
  ***************************************************************************************/
  ...
  nfile_lxo = 0;
  {
	...
	start[i] = 0; nwrite[i] = 1;
      ...
      start[0] = 0; nwrite[1] = strlen(amosaic);
      mpp_put_var_value_block(fid, id_mosaic, start, nwrite, amosaic);
      start[0] = 1; nwrite[1] = strlen(lmosaic);
      mpp_put_var_value_block(fid, id_mosaic, start, nwrite, lmosaic);
	...
	start[i] = 0; nwrite[i] = 1;
      ...
      start[0] = 0; nwrite[1] = strlen(amosaic);
      mpp_put_var_value_block(fid, id_mosaic, start, nwrite, amosaic);
      start[0] = 1; nwrite[1] = strlen(imosaic);
      mpp_put_var_value_block(fid, id_mosaic, start, nwrite, imosaic);
  ...
  ***************************************************************************************/
  ...
  if( !lnd_same_as_atm ) {
	...
	start[0] = 0; nwrite[1] = strlen(lmosaic);
	mpp_put_var_value_block(fid, id_mosaic, start, nwrite, lmosaic);
	start[0] = 1; nwrite[1] = strlen(imosaic);
	mpp_put_var_value_block(fid, id_mosaic, start, nwrite, imosaic);
  ...
  /*Fianlly create the coupler mosaic file mosaic_name.nc */
  {
    ...
    start[0] = 0; nwrite[1] = strlen(amosaic);
    mpp_put_var_value_block(fid, id_mosaic_file, start, nwrite, amosaic);
    start[0] = 1; nwrite[1] = strlen(lmosaic);
    mpp_put_var_value_block(fid, id_mosaic_file, start, nwrite, lmosaic);
    start[0] = 2; nwrite[1] = strlen(imosaic);
    mpp_put_var_value_block(fid, id_mosaic_file, start, nwrite, imosaic);
    start[0] = 3; nwrite[1] = strlen(omosaic);
    mpp_put_var_value_block(fid, id_mosaic_file, start, nwrite, omosaic);
    ...
    start[0] = 0; nwrite[0] = strlen(itopog); nwrite[1] = 1;
    mpp_put_var_value_block(fid, id_ocean_topog, start, nwrite, itopog);
    mpp_close(fid);
  }
